  ...
  return (
    ...
    >
      ...
      <button
        disabled={!value}
        type="submit"
        className="bg-primary disabled:bg-primary/50 absolute top-1/2 right-2 z-50 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full transition duration-200"
      >
        <motion.svg
